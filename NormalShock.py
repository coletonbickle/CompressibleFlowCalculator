...
#                 print(f"\nM1: {self.m1:8.8f} M2: {self.m2:8.8f} p02/01: {self.p02p01:8.8f}")
#                 print(f"p2/p1: {self.p2p1:8.8f} rho2/rho1: {self.r2r1:8.8f} T2/T1: {self.t2t1:8.8f}")
#             else:
#                 print(f"\nM1: {self.m1} M2: {self.m2} p02/01: {self.p02p01}")
#                 print(f"p2/p1: {self.p2p1} rho2/rho1: {self.r2r1} T2/T1: {self.t2t1}\n")
#                 print(self.msg)
#         else:
